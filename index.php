...
"key" => "bb525f095535fa1ef2fd42f3068afd56"
    ...
    "sky1-nz" => [
        ...
        "skypopup1-nz" => [
            "url" => "https://linear-s.media.skyone.co.nz/sky-sport-popup-1.mpd",
            "keyId" => "483191cddb8d48b7bbbba6b341960000",
            "key" => "a953a7f054bf4ece17451c54a6df3c15"
        ],
        "skypopup2-nz" => [
...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <?php foreach ($channels as $id => $channel): ?>
                    <li class="nav-item">
                        <a class="nav-link" href="player.php?id=<?php echo $id; ?>"><?php echo ucfirst($id); ?></a>
                    </li>
                <?php endforeach; ?>
            </ul>
        </div>
    ...
    <div class="container mt-4">
        <h1>Welcome to the Channel List</h1>
        <p>Select a channel from the navbar to view the stream.</p>
    </div>
